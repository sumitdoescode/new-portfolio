...
export const projects: Project[] = [
  {
    ...
    liveLink: "https://truefeedback.sumitdoescode.me/",
  },
  {
    id: 2,
    name: "Chatify",
  ...
  },
  {
    ...
    longDescription: (
      <>
        <p>Fake API is a lightweight mock REST API built for frontend developers to test applications without creating a real backend. The API includes 25+ endpoints covering users, posts, comments, animals, health checks, delay simulation, and IP detection.</p>
        ...
        <p>Built using Hono, TypeScript, Cloudflare Workers, and Zod, the API is optimized for fast response times and scalable performance. Seed data is loaded from local JSON files, while runtime-created data is temporarily stored in memory.</p>
